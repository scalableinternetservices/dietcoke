...
# Lambda URIs are "{+lambda}/{+function}" e.g. "dietcoke/ping".
# We also support path matching at the root e.g. "dietcoke" but these require definining separate "_root" terraform resources.
