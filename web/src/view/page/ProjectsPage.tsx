    ...
    <>
      ...
      <BodyText>
        <ul className="pl4">
          ...
          <li>
            Must use the class project framework located <Link href="https://github.com/rothfels/dietcoke">here</Link>
          </li>
            ...
            checklistFull={[
              {
                ...
                href: 'https://github.com/rothfels/dietcoke#quickstart',
              },
              {
              ...
              },
              {
                ...
                href: 'https://github.com/rothfels/dietcoke#run-react-storybook',
              },
            ]}
          />
          <Sprint
