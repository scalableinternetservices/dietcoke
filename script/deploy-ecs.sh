...
usage="Usage: deploy-ecs.sh [dietcoke-app-web|dietcoke-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/dietcoke:$2"
...
aws ecs update-service --cluster dietcoke \
  --no-cli-pager \
  --region "$ecs_region" \
