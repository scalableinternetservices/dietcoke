...
git clone https://github.com/rothfels/dietcoke.git $SLUG
cd $SLUG
rm -rf .git

sed -i.bak "s/dietcoke/$SLUG/g" **/*.tf
sed -i.bak "s/dietcoke/$SLUG/g" **/*.ts
sed -i.bak "s/dietcoke/$SLUG/g" **/*.yml
sed -i.bak "s/dietcoke/$SLUG/g" **/*.sh
sed -i.bak "s/dietcoke/$SLUG/g" **/*.json
rm -rf **/*.bak
